...
public class SweetBerryToastBlock extends Block {
    public static final IntProperty BITES = IntProperty.of("bite",1,4);
    public static final DirectionProperty FACING = Properties.HORIZONTAL_FACING;
    public SweetBerryToastBlock(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if(!world.isClient()&& itemStack.isOf(Items.WOODEN_SWORD)){
            ...
            if (i < 4) {
                ...
                player.giveItemStack(new ItemStack(ModItems.SWEET_BERRY_TOAST_SLICE,1));
